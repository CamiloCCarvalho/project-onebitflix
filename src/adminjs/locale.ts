...
export const locale: Locale = {
  ...
  translations: {
    ...
    labels: {
      ...
      courses: 'Cursos', //models
      episodes: 'Episódios', //models
      categories: 'Categorias', //models
      users: 'Usuários' //models
    },
    properties: {
    ...
    messages: {
      ...
      invalidCredentials: 'Usuário e/ou senha incorreto(s)',
    },
  }
} //search about documentation - adminJS
